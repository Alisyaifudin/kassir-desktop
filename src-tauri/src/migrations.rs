...
pub fn generate_migration() -> Vec<Migration> {
    let migrations = vec![
        ...
        Migration {
            version: 33,
            description: "add_fix",
            sql: include_str!("../src/migrations-sql/31-40/migration-33.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 34,
            description: "add_customers",
            sql: include_str!("../src/migrations-sql/31-40/migration-34.sql"),
            kind: MigrationKind::Up,
        },
        Migration {
            version: 35,
            description: "modify_additionals",
            sql: include_str!("../src/migrations-sql/31-40/migration-35.sql"),
            kind: MigrationKind::Up,
        },
    ];
    return migrations;
