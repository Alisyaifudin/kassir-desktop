...
function Table({ style, ref, ...props }: TableProps) {
  return (
    <Block style={styles.wrapper}>
      <table ref={ref} {...stylex.props([styles.table, style] as StyleXStyles)} {...props} />
    </Block>
  );
}
...
function TableHeader({ style, ref, ...props }: TableHeaderProps) {
  return <thead ref={ref} {...stylex.props([styles.header, style] as StyleXStyles)} {...props} />;
}
...
function TableBody({ style, ref, ...props }: TableBodyProps) {
  return <tbody ref={ref} {...stylex.props([styles.body, style] as StyleXStyles)} {...props} />;
}
...
function TableFooter({ style, ref, ...props }: TableFooterProps) {
  return <tfoot ref={ref} {...stylex.props([styles.footer, style] as StyleXStyles)} {...props} />;
}
...
function TableRow({ style, ref, ...props }: TableRowProps) {
  return <tr ref={ref} {...stylex.props([styles.row, style] as StyleXStyles)} {...props} />;
}
...
function TableHead({ style, ref, ...props }: TableHeadProps) {
  return <th ref={ref} {...stylex.props([styles.head, style] as StyleXStyles)} {...props} />;
}
...
function TableCell({ style, ref, ...props }: TableCellProps) {
  return <td ref={ref} {...stylex.props([styles.cell, style] as StyleXStyles)} {...props} />;
}
...
function TableCaption({ style, ref, ...props }: TableCaptionProps) {
  return (
    <caption ref={ref} {...stylex.props([styles.caption, style] as StyleXStyles)} {...props} />
  );
}
